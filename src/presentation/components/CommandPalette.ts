...
export class CommandPalette {
  ...
  */
  private readonly ICON_LIST: Array<{ id: string; topic: string; type: 'icon' }> = [
    ...
    { id: 'num_0_blue', topic: '0-blue', type: 'icon' },
    { id: 'num_1_blue', topic: '1-blue', type: 'icon' },
    { id: 'num_2_blue', topic: '2-blue', type: 'icon' },
    { id: 'num_3_blue', topic: '3-blue', type: 'icon' },
    { id: 'num_4_blue', topic: '4-blue', type: 'icon' },
    { id: 'num_5_blue', topic: '5-blue', type: 'icon' },
    { id: 'num_6_blue', topic: '6-blue', type: 'icon' },
    { id: 'num_7_blue', topic: '7-blue', type: 'icon' },
    { id: 'num_8_blue', topic: '8-blue', type: 'icon' },
    { id: 'num_9_blue', topic: '9-blue', type: 'icon' },
    { id: 'num_0_red', topic: '0-red', type: 'icon' },
    { id: 'num_1_red', topic: '1-red', type: 'icon' },
    { id: 'num_2_red', topic: '2-red', type: 'icon' },
    { id: 'num_3_red', topic: '3-red', type: 'icon' },
    { id: 'num_4_red', topic: '4-red', type: 'icon' },
    { id: 'num_5_red', topic: '5-red', type: 'icon' },
    { id: 'num_6_red', topic: '6-red', type: 'icon' },
    { id: 'num_7_red', topic: '7-red', type: 'icon' },
    { id: 'num_8_red', topic: '8-red', type: 'icon' },
    { id: 'num_9_red', topic: '9-red', type: 'icon' },
  ];
